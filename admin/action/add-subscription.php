        ...
        <div class="card-body">
            <form method="post" action="">
                ...
                <div>
                    ...
                    <input name="offer_price" type="number" id="offer_price" class="form-control">
                </div>

                <div>
                    <label for="regular_price" class="form-label">Regular Price</label>
                    <input name="regular_price" type="number" id="regular_price" class="form-control">
                </div>

                <div id="features-wrapper">
                    <div class="mb-3 feature-item">
                        <label for="features-1" class="form-label">Features</label>
                        <input name="features[]" id="features-1" class="form-control mb-2">
                    </div>
                </div>
                ...
                <div>
                    <button type="submit" name="add-subscription" id="submit" class="add-subscription">
                        Add Subscription
                    </button>
                </div>
            </form>
